...
class RemixDaoDcaWeekStratStrategy(Strategy):
    ...
    def check_and_add_dca(self, row_data: RowData):
        ...
        # self.dca_usdc_accumulated = self.total_invested * Decimal(0.3)
        self.dca_usdc_accumulated = self.gp.dca_usdc_amount * factor
        ...
        if base_used > ZERO or quote_used > ZERO:
            ...
            self.dca_total_added += self.dca_usdc_accumulated
            self.total_invested += self.dca_usdc_accumulated
